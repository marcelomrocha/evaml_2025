...
class Gui(ttk.Frame):
    def __init__(self, parent):
        ...
        parent.title("FRED - Audio Player")
        self.w = 180
        self.h = 170
        ...
        self.alto_falante1 = PhotoImage(file = "fred_audio/images/alto_falante1.png")
        self.alto_falante2 = PhotoImage(file = "fred_audio/images/alto_falante2.png")
        self.alto_falante3 = PhotoImage(file = "fred_audio/images/alto_falante3.png")
